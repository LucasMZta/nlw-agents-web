...
import type { CreateQuestionRequest, CreateQuestionResponse, GetRoomQuestionsResponse } from './types/questions'
            ...
            questions => {
               ...
               return questions.map(question => {
                  if (question.id === context.newQuestion.id) {
                     return { ...context.newQuestion, id: context.newQuestion.id, answer: data.answer, isGeneratingAnswer: false }
                  }
